...
public class QuadradoDeAsteriscos
{
    public static void main(String[] args)
    {
        ...
        int n = 21; // cria e inicializa o lado do quadrado
        int linha = 1; // cria e inicializa linha a ser exibida
        int coluna = 1; // cria e inicializa coluna a ser exibida
        
        while ( n > 20 ) // só permite valores menores do que 20 para o lado
        {
            // solicita a entrada do usuário
            System.out.print( "Digite o tamanho do lado do quadrado (<20): ");
            n = input.nextInt();
        } // fim do while
